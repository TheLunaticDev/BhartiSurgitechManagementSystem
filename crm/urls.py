...
urlpatterns = [
    ...
    path('manager/booking/', views.manager_booking_view, name="crm_manager_booking_view"),
    ...
    path('booking/toggle/<int:entry_id>/', views.toggle_crm_booking, name="crm_toggle_booking"),
    path('booking/render/table/<int:user_id>/', views.render_booking_table_for_user, name="crm_render_booking_table_for_user"),
    path('booking/change/<int:entry_id>/', views.change_booking_details, name="crm_change_booking_details"),
